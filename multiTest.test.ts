...
test('Test: To browse through Menu, select a category,  select a sub-category, add to favorites, sign-in, sign-out', async () => {
    ...
    await eviteTest.driver.sleep(1000)
    await eviteTest.clickGraduation() //click on sub-category "birthday for her"
    await eviteTest.driver.sleep(1000)
    ...
    await eviteTest.clickSignOutBtn() // click on sign out link 
    await eviteTest.driver.sleep(2000)
}) 
